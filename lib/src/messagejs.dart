...
class JSHeader {
  ...
  /// constructor
  JSHeader({this.headers, this.version = 'NATS/1.0'}) {
    this.headers ??= {};
  }

  /// add key, value
  JSHeader add(String key, String value) {
    headers![key] = value;
    return this;
  }
  ...
  static JSHeader fromBytes(Uint8List b) {
    ...
    return JSHeader(headers: m, version: version);
  }
...
class JSMessage<T> {
  ...
  ///constructor
  JSMessage(this.subject, this.sid, this.byte, this._client,
